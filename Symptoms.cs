...
internal static class Symptoms
{
    ...
    [Symptom("Aquaphobia", "You fear water", Symptom.SymptomType.Neutral, 50)] // TODO: When looking at water set fear to max
    ...
    public static StatusEffect Paranoia(Disease disease)
    {
        ...
        {
            if (disease.player == null) { return; }
            var clips = networkHandler.soundEffects[(int)LethalDiseasesNetworkHandler.SoundEffect.Paranoia].clips;
